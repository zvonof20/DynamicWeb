	...
	<div class="container">
		...
		<form action="" method="post">
			<label for="name">Name:</label> <input type="text" name="name"
				id="name" required><br> <label for="id">ID:</label> <input
				type="number" name="id" id="id" required><br> <input
		...
		<ul class="book-list">
			...
			%><li class="book-list-item"><%=book%> <a
				href="EditJsp.jsp?book=<%=book%>">Edit</a> <a
				href="DeleteJsp.jsp?book=<%=book%>">Delete</a></li>
			<%
			}
			%>
		</ul>
